...
parser = argparse.ArgumentParser(description='Python coinexchange.io dataminer.')
parser.add_argument('--profitloss', dest='enableProfitLossAlerts', action='store_true', help='Enables alerts for profit and loss according to alert_list.csv')
parser.add_argument('--pricedrop', dest='enablePriceDropAlerts', action='store_true', help='Enables alerts for coin values at 1 sat')
...
def main( kwargs ):
    ...
    if not kwargs['enableProfitLossAlerts']:
        print "Profit/Loss alerts are disabled."
        kwargs["enableProfitLossAlerts"] = False
    if not kwargs['enablePriceDropAlerts']:
        print "Price drop alerts are disabled."
        kwargs["enablePriceDropAlerts"] = False
    ...
    while True:
        ...
        try:
            ...
            if kwargs["enableProfitLossAlerts"]:
                # *********************************************************************
                # Process Alerts
                # *********************************************************************
            ...
            if kwargs["enablePriceDropAlerts"]:
                # *********************************************************************
